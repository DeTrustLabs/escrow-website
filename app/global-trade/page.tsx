...
import { Target, Shield, Clock, ArrowRight, CheckCircle, Briefcase, DollarSign, FileText, Globe, Truck, Play, TrendingDown } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">What Traders Say</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  "Finally, I can work with new suppliers without worrying about payment. The USDC is locked in escrow
                  before they ship, and I get it back if goods don't arrive."
                </p>
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Electronics Importer, Germany</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  "No more waiting 30 days for wire transfers. My buyers deposit stablecoins upfront, and I get paid
                  instantly when the container arrives at their port."
                </p>
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                    <span className="text-primary font-semibold">JL</span>
                  </div>
                  <div>
                    <p className="font-semibold">James L.</p>
                    <p className="text-sm text-muted-foreground">Textile Exporter, Vietnam</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  "The transparency is incredible. Both parties can see the shipping status and exactly when payment
                  will be released. No more disputes about delivery."
                </p>
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold">Ahmed R.</p>
                    <p className="text-sm text-muted-foreground">Commodity Trader, UAE</p>
                  </div>
                </div>
              </CardContent>
            </Card>
