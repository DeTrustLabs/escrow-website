            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">
                    {t(
                      "releaseMechanisms.mechanisms.deliveryConfirmation.title"
                    )}
                  </CardTitle>
                  <CardDescription>
                    {t(
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">
                    {t(
                      "releaseMechanisms.mechanisms.thirdPartyVerification.title"
                    )}
                  </CardTitle>
                  <CardDescription>
                    {t(
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    {t(
                      "releaseMechanisms.mechanisms.documentBased.description"
                    )}
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    {t(
                      "releaseMechanisms.mechanisms.mutualAgreement.description"
                    )}
                  </CardDescription>
                </CardHeader>
              </Card>
