          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              >
                ...
                <AccordionContent className="pt-4 pb-2">
                  <p className="text-muted-foreground leading-relaxed">
                    Project owners often pay upfront and wait for delivery,
                    leaving them vulnerable to freelancers who disappear or fail
                    to complete work. This can result in significant financial
                    losses and project delays. Many project owners have
                    experienced situations where freelancers simply vanish after
                    receiving payment, leaving them with no work and no recourse
                    for recovery.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="pt-4 pb-2">
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    leads to additional costs and delays, especially when
                    freelancers demand extra payment for revisions that should
              ...
              >
                ...
                <AccordionContent className="pt-4 pb-2">
                  <p className="text-muted-foreground leading-relaxed">
                    Missed deadlines and project delays can have serious
                    business consequences, especially for time-sensitive
                    projects or product launches. Freelancers may overcommit,
                    underestimate project complexity, or simply lack proper
                    project management skills. These delays can impact business
                    operations, marketing campaigns, and competitive positioning
                    in the market.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="pt-4 pb-2">
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    options for dispute resolution. Traditional legal remedies
                    are expensive and time-consuming, especially for smaller
                    projects. Platform dispute systems may be biased or
                    ineffective, leaving project owners with little recourse
                    when freelancers fail to deliver or deliver substandard
                    work.
                  </p>
                </AccordionContent>
              </AccordionItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  payment is only released when work meets specifications. No
                  more paying upfront and hoping for the best.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  deliverables meet your requirements and quality standards
                  before the freelancer receives payment.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  ensures work completion before payment. Access a broader
                  talent pool without worrying about reliability.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Reduced transaction fees compared to traditional platforms
                  mean more budget for actual project work. Direct payments
                  eliminate platform middlemen and their associated costs.
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20">
        <div className="container px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of project owners who never worry about project
              risks again. Start your first secure project today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="https://qhsea-iaaaa-aaaaj-qa6kq-cai.icp0.io"
